...
void ReactionTimeGame::update(uint32_t deltaTime, Keyboard& keyboard, Joystick& joystick)
{
    if (gameComplete)
    {
        return;
...
bool ReactionTimeGame::isComplete()
{
    return gameComplete;
}

const char* ReactionTimeGame::getName()
{
