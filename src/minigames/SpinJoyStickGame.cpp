...
void JoystickSpinGame::update(uint32_t deltaTime, Keyboard& Keyboard, Joystick& joystick)
{
...
bool JoystickSpinGame::isComplete()
{
    return gameComplete;
}

const char* JoystickSpinGame::getName()
{
    return "Joystick Spin";
}
