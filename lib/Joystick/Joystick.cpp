...
{
    position.x = map(analogRead(pinA), 0, 1023, JOYSTICK_BEGIN_VAL, JOYSTICK_END_VAL);
    position.y = map(analogRead(pinB), 0, 1023, -JOYSTICK_BEGIN_VAL, JOYSTICK_END_VAL);
